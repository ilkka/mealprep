defmodule MealprepBackend.V1.ComponentClassView do
  ...
  def render("index.json", %{componentclasses: componentclasses}) do
    %{data: render_many(componentclasses, MealprepBackend.V1.ComponentClassView, "component_class.json")}
  end

  def render("show.json", %{component_class: component_class}) do
    %{data: render_one(component_class, MealprepBackend.V1.ComponentClassView, "component_class.json")}
  end
